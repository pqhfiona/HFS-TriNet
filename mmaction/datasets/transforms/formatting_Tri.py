...
class PackActionInputs(BaseTransform):
    ...
    def transform(self, results: Dict) -> Dict:
        ...
        # 将外部特征添加到 data_sample
        if 'features' in results:
            external_features = results['features']
            data_sample.external_features = external_features

        if 'wt_features' in results:
            wt_features = results['wt_features']
            data_sample.wt_features = wt_features
