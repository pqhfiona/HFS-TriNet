...
def parse_args():
    ...
    config_files = [
        # 'tpn-slowonly_r50_stable_8xb8-8x8x1-150e_kinetics400-rgb.py' , # 使用稳定配置
    ...
    parser = argparse.ArgumentParser(description='Distributed train a action recognizer')
    ...
    parser.add_argument(
        ...
        default='pytorch',  # 默认使用pytorch分布式
        help='job launcher')
