...
new_working_directory = "/work/data/yancy/mmaction2v3/mmaction2"
# new_working_directory = "/home/hw/data/yancy/envs/mmaction2v3/mmaction2"
...
def parse_args():
    ...
    default_config_path = os.path.join(
        os.getenv('MY_DEFAULT_CONFIG', './configs/recognition/mywork/test_modified_modle'), config_files[model_index])
